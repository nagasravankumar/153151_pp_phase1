...
public class TestClass {
	...
	{
		service.createAccount(null, "9876543110", new BigDecimal(1500));
	}
	...
	{
		service.createAccount("", "9876543110", new BigDecimal(1500));
	}
	...
	{
		Customer actual=service.createAccount("Sravan", "9698495659", new BigDecimal(5000));
		Customer expected=new Customer("Sravan", "9698495659", new Wallet(new BigDecimal(5000)));
	...
	{
		Customer actual=service.createAccount("Sravan", "8754922472", new BigDecimal(0));
		Customer expected=new Customer("Sravan", "8754922472", new Wallet(new BigDecimal(0)));
	...
	public void testCreateAccount10() 
	{
		...
		Customer expected=new Customer("Eric", "8754922472", new Wallet(new BigDecimal(5000.75)));
